    ...
    def _send_cmd(self, joint_rads, gripper: int):
        if self.simulation_mode:
            ...
            for _ in range(20):
                ...
                joint_state_msg.position = joint_positions + [0.0, 0.0]
